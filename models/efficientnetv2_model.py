# Builds a transfer-learning model using EfficientNetV2 for pneumonia classification.
#     Args:
...
def build_efficientnetv2_model(input_shape=(224, 224, 3), num_classes=2, learning_rate=0.001, fine_tune=True):
    # Load the EfficientNetV2B0 model pre-trained on ImageNet, excluding the top layers
